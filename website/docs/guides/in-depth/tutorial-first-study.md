<!-- GENERATED by website/scripts/build_guides.py from docs/08_guides/tutorial-first-study.md — DO NOT EDIT. -->
...
test](https://github.com/SoundMindsAI/relyloop/blob/main/backend/tests/smoke/test_tutorial_path.py) exercises in CI on
...
[`docs/01_architecture/llm-orchestration.md` §"OpenAI-compatible endpoints"](https://github.com/SoundMindsAI/relyloop/blob/main/docs/01_architecture/llm-orchestration.md).
...
the `SolrAdapter`. See
[`solr-cluster-registration.md`](https://github.com/SoundMindsAI/relyloop/blob/main/docs/03_runbooks/solr-cluster-registration.md)
...
[`llm-orchestration.md`](https://github.com/SoundMindsAI/relyloop/blob/main/docs/01_architecture/llm-orchestration.md).
...
See the [UBI judgment-generation runbook](https://github.com/SoundMindsAI/relyloop/blob/main/docs/03_runbooks/ubi-judgment-generation.md)
...
- **Convergence chip** — *Converged* / *Still improving* / *Too few
  ...
  [`feat_study_convergence_indicator`](https://github.com/SoundMindsAI/relyloop/blob/main/docs/00_overview/implemented_features/2026_06_01_feat_study_convergence_indicator/feature_spec.md).
...
- [`samples/templates/README.md`](https://github.com/SoundMindsAI/relyloop/blob/main/samples/templates/README.md) —
...
- [`samples/templates/solr/README.md`](https://github.com/SoundMindsAI/relyloop/blob/main/samples/templates/solr/README.md) —
...
- [`docs/06_vendor_docs/elasticsearch-tunable-params.md`](https://github.com/SoundMindsAI/relyloop/blob/main/docs/06_vendor_docs/elasticsearch-tunable-params.md)
- [`docs/06_vendor_docs/opensearch-tunable-params.md`](https://github.com/SoundMindsAI/relyloop/blob/main/docs/06_vendor_docs/opensearch-tunable-params.md)
  (covers OpenSearch's hybrid normalization-processor — NOT the ES
  `rrf` retriever)
- [`docs/06_vendor_docs/solr-tunable-params.md`](https://github.com/SoundMindsAI/relyloop/blob/main/docs/06_vendor_docs/solr-tunable-params.md)
  (grounded in the checked-in Solr 9 / 10 ref-guide source)

### The rest of the project

- The full feature set is in [`docs/02_product/mvp1-user-stories.md`](https://github.com/SoundMindsAI/relyloop/blob/main/docs/02_product/mvp1-user-stories.md).
- The architectural decisions are in
  [`docs/01_architecture/`](https://github.com/SoundMindsAI/relyloop/tree/main/docs/01_architecture/) — start with
  [`system-overview.md`](https://github.com/SoundMindsAI/relyloop/blob/main/docs/01_architecture/system-overview.md).
- The umbrella product spec is at
  [`docs/00_overview/relyloop-spec.md`](https://github.com/SoundMindsAI/relyloop/blob/main/docs/00_overview/relyloop-spec.md).
