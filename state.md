...
- **Branch:** `main` (clean). `feat_study_convergence_indicator` merged via PR #352 (squash, merge commit `0eee17a9`); finalization on `docs/finalize-study-convergence-indicator` (this branch).
...
- _None._ `feat_study_convergence_indicator` (PR #352) merged 2026-06-01; finalization on `docs/finalize-study-convergence-indicator` (this branch).
