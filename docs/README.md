...
- **Planned-features folder naming:** new folders under `02_product/planned_features/` use a single-axis work-type prefix: `feat_`, `infra_`, `chore_`, `bug_`, or `epic_`. See [`02_product/planned_features/feature_templates/README.md`](02_product/planned_features/feature_templates/README.md).
...
- FastAPI + `/healthz` operator probe ([`02_product/planned_features/infra_foundation/feature_spec.md`](02_product/planned_features/infra_foundation/feature_spec.md) §7)
...
The next 11 MVP1 features are spec-approved and queued under [`02_product/planned_features/`](02_product/planned_features/). See [`../state.md`](../state.md) for priority order.
