...
| Search engines (targets) | Elasticsearch 8.11+ / 9.x; OpenSearch 2.x / 3.x (MVP1); Apache Solr 9.x / 10.x (MVP2) | These three OSS engines are the only supported targets. |
