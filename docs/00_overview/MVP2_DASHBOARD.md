...
|---|---|---|---|---|---|---|
| 1 | P1 | [infra_adapter_solr](planned_features/02_mvp2/infra_adapter_solr/idea.md) | Infra | After MVP1.5, RelyLoop runs against Elasticsearch and OpenSearch — but the "engine-neutral" positioning is aspirational until a third engine ships. Apache Solr is the right third engine because: | — | Idea — sole remaining P1 anchor for MVP2 / v0.2 "Three-Engine + Real Signals" after [`feat_ubi_judgments`](../../../implemented_features/2026_05_29_feat_ubi_judgments/) shipped solo (PR #317, 2026-05-29). Landing Solr extends the just-shipped UBI path to a third engine with zero UBI code changes. |
