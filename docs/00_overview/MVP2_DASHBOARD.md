...
| Specced features done | **19 / 29** (66%) — of features *past the idea stage* (those with a spec); the idea backlog below is NOT in this denominator, so 100% ≠ release complete |
...
| 2 | P2 | [feat_overnight_final_solution_phase3](planned_features/02_mvp2/feat_overnight_final_solution_phase3/feature_spec.md) | Feature | Non-winning chain links' proposals transition `pending → superseded` when the chain terminates. | — | [PR #440](https://github.com/SoundMindsAI/relyloop/pull/440) merged 2026-06-04 |
...
graph LR
  ...
  class feat_overnight_final_solution_phase3 plan;
