...
| Specced features done | **26 / 29** (90%) — of features *past the idea stage* (those with a spec); the idea backlog below is NOT in this denominator, so 100% ≠ release complete |
...
graph LR
  ...
  class feat_selective_engine_startup_and_demo implement;
