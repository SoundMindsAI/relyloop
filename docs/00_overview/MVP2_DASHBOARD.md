...
| 3 | P2 | [chore_guide_regen_after_list_count_columns](planned_features/02_mvp2/chore_guide_regen_after_list_count_columns/idea.md) | Chore | `ui/public/guides/03_create_query_template/01-templates-list.png` + `ui/public/guides/04_create_query_set/01-query-sets-list.png` (and the `02-create-modal-*` screenshots that show the list behind the | — | Idea — deferred from `feat_list_count_columns` PR (forthcoming, the one shipping `query_count` + `param_count` list-summary fields) |
