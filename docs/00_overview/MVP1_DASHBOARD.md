...
| Metric | Value |
|---|---|
| Scoped items done | **79 / 80** (99%) — feat_/infra_/chore_/epic_ past idea stage |
...
| 4 | P2 | [chore_dashboard_regen_quoted_pr_false_positive](../02_product/planned_features/chore_dashboard_regen_quoted_pr_false_positive/idea.md) | Chore | [`_extract_pr_number`](../../scripts/build_mvp1_dashboard.py#L581)'s priority-3 fuzzy match has two regexes (verified 2026-05-25 against current main at `2a24fae4`): | — | Idea — surfaced during `chore_dashboard_pr_extraction_from_idea` empirical verification (2026-05-23) |
