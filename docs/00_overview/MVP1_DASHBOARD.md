...
| [bug_capability_check_test_isolation](../02_product/planned_features/bug_capability_check_test_isolation/idea.md) | Bug | Idea — deferred from `infra_adapter_elastic` Story 5.1; still applies to `main` as of `c6a46a3`. | — | Idea — deferred from `infra_adapter_elastic` Story 5.1; still applies to `main` as of `c6a46a3`. |
