...
| [bug_confidence_per_query_metric_key_drift](../02_product/planned_features/bug_confidence_per_query_metric_key_drift/idea.md) | Bug | The two implementations disagree on the shape of `trials.per_query_metrics`: | — | Idea (filed 2026-05-21; surfaced by Story 1.5 of `feat_pr_metric_confidence`) |
