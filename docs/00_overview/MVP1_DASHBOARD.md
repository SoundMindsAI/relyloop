...
|---|---|---|---|---|---|---|
| 1 | P1 | [bug_smoke_create_study_modal_e2e_max_trials_fill](../02_product/planned_features/bug_smoke_create_study_modal_e2e_max_trials_fill/idea.md) | Bug | After PR #215 added the Stop-condition preset selector to [`ui/src/components/studies/create-study-modal.tsx`](../../ui/src/components/studies/create-study-modal.tsx), the Playwright E2E case… | — | Idea — regression introduced by `chore_study_default_stop_conditions` PR #215 |
