...
**Deferred phase tracking:** Phase 2 is tracked in [`phase2_idea.md`](../infra_openapi_types_freshness_gate/idea.md) (created with this spec). If the pipeline runs both phases in one implementation pass, the `phase2_idea.md` is folded into the plan and may be retired at finalization; if Phase 1 ships alone, `phase2_idea.md` remains the discoverable record of the deferred work.
