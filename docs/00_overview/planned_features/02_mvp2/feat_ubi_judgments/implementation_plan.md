...
- [ ] Story 1.1 — Migration `0021_judgment_lists_generation_params`
...
- [ ] Story 3.4 — `generate_judgments_from_ubi` agent tool + orchestrator prompt update
...
- [ ] Story 5.2 — E2E suite + `seed_ubi.ts` helper
