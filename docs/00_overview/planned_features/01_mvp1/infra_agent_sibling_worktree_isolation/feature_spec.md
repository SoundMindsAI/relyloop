...
- Given the post-merge state of `docs/00_overview/planned_features/01_mvp1/infra_agent_sibling_worktree_isolation/`
...
| (out of FR — Step 10 deferred-phase tracking) | AC-8 | Story 1.2 | (PR review + `/pipeline status` smoke) | `docs/00_overview/planned_features/01_mvp1/infra_agent_sibling_worktree_isolation/phase2_idea.md`, `phase3_idea.md` |
