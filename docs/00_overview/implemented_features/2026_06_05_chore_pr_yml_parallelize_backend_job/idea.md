...
- Hands off the lane-split + split-by-service residual to [`infra_pr_yml_split_backend_test_lanes`](../../planned_features/02_mvp2/infra_pr_yml_split_backend_test_lanes/idea.md) (deferred). The lint-dedup shipped here is a pure subtraction from the heavy job; the deferred work is a structural split.
