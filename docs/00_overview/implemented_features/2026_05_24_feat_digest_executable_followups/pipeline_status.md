...
- **Phase 1 audit trail complete.** Both deferred phases were split to standalone sibling folders on 2026-05-24: Phase 2 → [`../../../02_product/planned_features/feat_digest_executable_followups_swap_template/`](../../../02_product/planned_features/feat_digest_executable_followups_swap_template/idea.md) (PR #229); Phase 3 → [`../../../02_product/planned_features/backlog_feat_digest_template_edit_followups/`](../../../02_product/planned_features/backlog_feat_digest_template_edit_followups/idea.md) (PR #227). With no `phase*_idea.md` files remaining, the parent folder moved here per `impl-execute` Step 8.
