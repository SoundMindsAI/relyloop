...
All spec FRs (FR-1 … FR-9) are covered. The spec defines two phases; **this plan covers both** (Epic 1 = Phase 1, Epic 2 = Phase 2). [`infra_openapi_types_freshness_gate`](../infra_openapi_types_freshness_gate/idea.md) remains as the standalone record if execution ships Epic 1 alone.
